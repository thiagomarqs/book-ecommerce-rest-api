...
(1, 'Rua dos Bobos', '01234-567', 'SÃO PAULO', '', '2022-12-25', '0', 'SÃO PAULO', 'BILLING', 'SP', 2),
(1, 'Fake Street', '32124-567', 'SÃO PAULO', 'just testing', '2022-12-25', '123', 'SÃO PAULO', 'SHIPPING', 'SP', 2),
(1, 'Billing Address', '32123-567', 'SÃO PAULO', 'test', '2022-12-25', '154', 'SÃO PAULO', 'BILLING', 'SP', 3);
...
('Fantasy', 1, 'Fantasy books.'),
('Sci-Fi', 1, 'Sci-fi books.'),
('Drama', 0, 'Drama books.'),
('Romance', 1, 'Romance books.'),
('Self help', 1, 'Self help books.');

INSERT INTO PUBLISHER (NAME, ACTIVE, SITE) VALUES
('Pub Books', 1, 'https://www.pubbooks.com'),
('Publi & Sher Books', 1, 'https://www.publisherbooks.com'),
('Books Pub', 1, 'https://www.bookspub.com'),
('Inactive Publisher', 0, 'https://www.inactivepublisher.com');
...
INSERT INTO CART_ITEM(CUSTOMER_ID, BOOK_ID, PRICE, UNITS, SUB_TOTAL, CURRENCY, ADDED_AT, MODIFIED_AT) VALUES
(2, 1, 39.99, 1, 39.99, 'BRL', '2023-01-05', '2023-01-05'), -- id 1
(2, 2, 35.99, 1, 35.99, 'BRL', '2023-01-05', '2023-01-05'), -- id 2
(3, 1, 39.99, 1, 39.99, 'BRL', '2023-01-05', '2023-01-05'), -- id 3
(3, 2, 35.99, 1, 35.99, 'BRL', '2023-01-05', '2023-01-05'); -- id 

INSERT INTO PAYMENT_METHOD(ID, TYPE, NUMBER, HOLDER, EXP_MONTH, EXP_YEAR, CVV, CUSTOMER_ID) VALUES
('ada6ffa5-aab6-4b78-8c76-294e2e8b9501', 'CREDIT', '1234123412341234', 'Customer 2', 12, 2029, 123, 3);